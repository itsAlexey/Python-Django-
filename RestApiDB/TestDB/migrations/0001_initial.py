# Generated by Django 4.2.9 on 2024-02-22 07:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interfaces', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='TestDB.interface')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='networkDevice',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='TestDB.networkdevice'),
        ),
        migrations.AddField(
            model_name='interface',
            name='trafficDataInterface',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='TestDB.trafficdata'),
        ),
    ]
