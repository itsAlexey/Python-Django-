# Generated by Django 4.2.9 on 2024-03-15 12:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=150, verbose_name='Местонахождение')),
                ('IPAddressNetworkDevice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ipaddress_network_device', to='TestDB.ipaddress', verbose_name='IP-адрес')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devicePowerConsumption', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='power_consumption', to='TestDB.networkdevice', verbose_name='Сетевое устройство')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostdevicePacketLossData', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='TestDB.hostdevice', verbose_name='IP адрес')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='type_network_device', to='TestDB.typedevices', verbose_name='Тип устройства'),
        ),
        migrations.AddField(
