# Generated by Django 4.2.9 on 2024-02-21 11:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TestDB.users', verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(verbose_name='Время')),
                ('power_consumption', models.FloatField(max_length=5, verbose_name='Потребление энергии')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TestDB.networkdevice', verbose_name='Сетевое устройство')),
                ('host_device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TestDB.hostdevice', verbose_name='Устройство')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TestDB.typedevices', verbose_name='Тип устройства'),
        ),
        migrations.CreateModel(
            name='ErrorLog',
            fields=[
